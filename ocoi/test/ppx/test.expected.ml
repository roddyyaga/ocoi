...
include struct
          ...
          | [] -> (
              ...
              | [] -> (
                  ...
                  | _ ->
                      ...
                      .record_undefined_elements _tp_loc yojson
                        [
    ...
    ( function
      | { id = v_id; name = v_name; cool = v_cool; another_id = v_another_id }
        ->
          ...
          let bnds =
            let arg = yojson_of_int v_another_id in
            ("another_id", arg) :: bnds
          in
          let bnds =
            let arg = yojson_of_bool v_cool in
            ("cool", arg) :: bnds
          in
          let bnds =
  ...
  type t_no_id = { name: string; cool: bool; another_id: int }
  [@@deriving yojson]
      ...
      ( let _tp_loc = "test.ml.t_no_id" in
                ...
                | [] -> (
                    match
                      ( Ppx_yojson_conv_lib.( ! ) name_field,
                        ...
                        Ppx_yojson_conv_lib.( ! ) another_id_field )
                    with
                    | Some name_value, Some cool_value, Some another_id_value ->
                        {
                          name = name_value;
                          cool = cool_value;
                          another_id = another_id_value;
        ...
        | _ as yojson ->
            Ppx_yojson_conv_lib.Yojson_conv_error.record_list_instead_atom
              _tp_loc yojson
        : Ppx_yojson_conv_lib.Yojson.Safe.t -> t_no_id )
    ...
    let yojson_of_t_no_id =
      ( function
        | { name = v_name; cool = v_cool; another_id = v_another_id } ->
            ...
            in
            `Assoc bnds
        : t_no_id -> Ppx_yojson_conv_lib.Yojson.Safe.t )
